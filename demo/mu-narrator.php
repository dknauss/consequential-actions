	...
	function () {
		...
		if ( 'profile' === $screen->id ) {
			...
			echo '<div class="notice notice-info"><p><strong>Prove it over the REST API.</strong> '
				...
				. 'interactive session &mdash; confirm in wp-admin, and the window that opens is bound '
				. 'to <em>this browser&rsquo;s</em> login session. A cloned cookie, a second device, or '
				. 'an Application Password cannot borrow it.</p>'
